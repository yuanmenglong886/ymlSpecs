#
#  Be sure to run `pod spec lint runtimeKit.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  # Or just: s.author    = "yuanmenglong886"
  # s.authors            = { "yuanmenglong886" => "email@address.com" }
  # s.social_media_url   = "http://twitter.com/yuanmenglong886"
  ...
  s.source_files  =  'NAME_OF_POD/Classes/**/*'# "Classes/*.{h,m}"
